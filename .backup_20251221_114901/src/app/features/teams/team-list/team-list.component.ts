      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div class="flex gap-3 w-full md:w-auto">
          <div class="relative flex-1 md:w-64">
            ...
            <input type="text" [(ngModel)]="searchQuery" placeholder="Nom ou type..." class="w-full pl-9 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none text-sm" (ngModelChange)="page.set(1)">
          </div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="overflow-x-auto">
          <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-slate-100">
              @for (team of paginated(); track team) {
        ...
        <div class="data-pagination-footer flex flex-col md:flex-row gap-3 items-center justify-between px-6 py-3 border-t border-slate-200 bg-slate-50">
          <div class="text-sm text-slate-500">
            ...
            <span class="font-semibold">{{ this.filteredTeams().length }}</span> résultats
          </div>
