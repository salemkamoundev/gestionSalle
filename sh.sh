...
# ============================================================
# Dashboard : Vue Aujourd'hui + Impayés Semaine
# ============================================================

echo "🚀 Mise à jour du Dashboard (Vue Journalière & Financière)..."
...
echo "✅ Dashboard mis à jour avec les vues journalières et financières."