...
# ============================================================
# Correction "Inconnu" : Utilisation de Computed Maps
# ============================================================

echo "🔧 Correction de l'affichage des noms (Staff/Équipes)..."
...
echo "✅ Affichage corrigé : Les noms s'afficheront instantanément."