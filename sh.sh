...
# Correction : Remplacement de le type de toast 'warning' (non supporté) par 'error'.
...
echo "✅ Formulaire de réservation corrigé : Type de toast valide ('error') et validation client."