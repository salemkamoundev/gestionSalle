...
echo "⚙️  Correction du mappage des créneaux (Matin -> as_matin_2025)..."
...
echo "✅ Correction appliquée. Le lien entre 'matin' et 'as_matin_2025' est maintenant opérationnel."