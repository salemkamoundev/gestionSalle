      ...
      <div class="bg-white p-4 rounded-xl shadow-sm border border-slate-200 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="relative group">
          ...
          <div class="relative">
            ...
            <input type="text" [(ngModel)]="searchQuery" placeholder="N° Reçu, Chèque ou Montant" class="w-full pl-9 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none text-sm">
          </div>
        </div>
      </div>
